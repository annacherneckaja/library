    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                <div class="logo"><a href="http://library.com/admin" class="navbar-brand"><span
...
<!--                                <div id="list" size="" class="bAutoComplete mSearchAutoComplete"></div>-->
            ...
            <div class="form-group"">
                <a href="#" onclick="logout();">
                    <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-briefcase-fill" fill="#b1dfbb"
...
<script type="text/javascript">
    function logout() {
        ...
        if (window.ActiveXObject) {
            ...
            window.location.href='http://library.com';
        } else {
            xmlhttp.open("GET", 'http://library.com/admin', true, "logout", "logout");
            xmlhttp.send("");
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4) {window.location.href='http://library.com';}
            }
        }
        return false;
    }
